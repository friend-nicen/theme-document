...
<div class="div-info">
    ...
    <form class="comment-form" action="/wp-comments-post.php" method="post">
        ...
        <div class="comment-form-main">
            ...
            <input type="hidden" name="comment_parent" value=" <?php echo $reply_to_id ? $comment->comment_ID : ''; ?>">
            ...
            <div class="comment-container">
                <input placeholder="昵称" name="author" type="text" class="comment-name" value="<?= $nickname ?>" required/>
                <input placeholder="邮箱" name="email" type="email" class="comment-mail" value="<?= $email ?>" required/>
                <input placeholder="网址" name="url" type="url" class="comment-url" value="<?= $webUrl ?>" required/>
            </div>
        </div>
    ...
    <div class="comment_list">
        <ul class="front">
            <?php wp_list_comments(['style'=>'ul', 'type'=> 'all','walker' => (new CommentsWalker())]); ?>
        </ul>
    </div>
