 ...
 * 根据文章内容生成侧边导航
 * */
function nicen_theme_navigator($content)
{
        ...
        if (strpos($item[0], 'h1') !== false) {
            ...
            $replace .= '<li>
							<div class="first-index">
								<div><a href="#h2' . $h1_number . '" nicen_theme_title="' . $temp . '">' . $temp . '</a></div>
							</div>
						</li>';
            $h1_number++;
            ...
            $replace .= '<li>
							<div class="secondary-index">
								<div><a href="#h3' . $h2_number . '" nicen_theme_title="' . $temp . '">' . $temp . '</a></div>
							</div>
						</li>';
            $h2_number++;
            ...
            $replace .= '<li>
							<div class="third-index">
								<div><a href="#h4' . $h3_number . '" nicen_theme_title="' . $temp . '">' . $temp . '</a></div>
							</div>
						</li>';
            $h3_number++;
        }
