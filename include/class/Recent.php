...
class Recent extends WP_Widget
{
    ...
    {
        parent::__construct(false, $name = '最新文章（Document部件）',[
    ...
    function widget($args, $instance)
    {
        ...
        include get_template_directory() . '/template/widget/recent.php';//最新文章
        ...
        <p>
            <label for="<?php echo $this->get_field_id('number'); ?>">
                ...
                <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>"
                       ...
                       type="text"
                       value="<?php echo $this->getValue($instance, 'title', '最新文章'); ?>"/></label>
        </p>
        <?php
    }
