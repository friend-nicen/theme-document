...
class Author extends WP_Widget
{
    ...
    {
        parent::__construct(false, $name = '作者信息（Document部件）', [
    ...
    function widget($args, $instance)
    {
        ...
        $avatar = $this->getValue($instance, 'avatar', '/wp-content/themes/document/assets/images/avatars.jpg');//作者logo
        $nickname = $this->getValue($instance, 'nickname', '友人a丶'); //作者昵称
        $profession = $this->getValue($instance, 'profession', 'PHPer'); //职业描述
        $beijin = $this->getValue($instance, 'beijin', '/wp-content/themes/document/assets/images/bg.jpg'); //作者卡片背景
